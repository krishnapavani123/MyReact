...
<div>
    ...
    <div className='c-1'>
                <h1 className='para1'>TRADE</h1>
                <h1 className='head11'>Trade Materials
              </h1>
...
<p className='t-para'>Sheet</p>
                ...
                <div className='t-f'>
                    ...
                    <h1 className='t-head1'>Partners in Wine</h1>
                    <p className='t-para1'>We self-distribute in Multnomah and Yamhill counties. We would be glad to direct you to a local wine retailer. We also partner with Portland's Casa Bruno so that our wine can be delivered statewide. Our out-of-state partners are listed below.</p>
...
<div>
    ...
    <p className='para1'>California</p>
    <p className='t-para'>Northwest Wines, Ltd.</p>
   <p className='t-para'> 415.665.9013 | Website</p>
</div>
<div>
